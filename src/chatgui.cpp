    ...
    : wxScrolledWindow(parent, id)
{
    ...
    _uniPtrChatLogic = std::make_unique<ChatLogic>(); 

    // pass pointer to chatbot dialog so answers can be displayed in GUI
    _uniPtrChatLogic->SetPanelDialogHandle(this);

    // load answer graph from file
    _uniPtrChatLogic->LoadAnswerGraphFromFile(dataPath + "src/answergraph.txt");
